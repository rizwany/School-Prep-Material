...
check((11 - 1) === 10 && 10 === 10, 'Charisma-positive responses score toward 10');
check((11 - 10) === 1 && 1 === 1, 'Charisma-negative responses score toward 1');
...
check(home.includes('charisma_test/index.html'), 'Homepage links to English test');
check(home.includes('charisma_test/urdu.html'), 'Homepage links to Urdu test');
check(home.includes('Charisma Test') && home.includes('کشش شخصیت کا ٹیسٹ'), 'Homepage includes bilingual section title');
