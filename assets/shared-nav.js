...
(function () {
  ...
  var css = [
    ...
    "}",
    ".lp-nav-left{display:flex;align-items:center;gap:10px;flex-shrink:0;}",
    ...
    /* ─ nav links ─ */
    ".lp-nav-links{flex:1;display:flex;align-items:center;justify-content:center;gap:2px;}",
    ".lp-nav-link{",
    ...
    el.innerHTML = [
      '<div class="lp-nav-inner">',
        '<div class="lp-nav-left">',
          '<a class="lp-nav-logo" href="' + root + '" aria-label="LearnPad – Home">',
        ...
        '<nav class="lp-nav-links" id="lpNavLinks" aria-label="Main navigation">',
          '<a class="lp-nav-link' + active('school')    + '" href="' + root + '#school">🏫 School</a>',
          '<a class="lp-nav-link' + active('learnings') + '" href="' + root + '#learnings">🤖 Tech in Urdu</a>',
          '<a class="lp-nav-link' + active('mathfun')   + '" href="' + root + '#mathfun">🎮 Knowledge Check</a>',
        '</nav>',
      ...
      '<div class="lp-footer-inner">',
        ...
        '<div>',
          ...
          '<ul class="lp-footer-nav">',
            ...
            '<li><a href="' + root + '#school">School Worksheets</a></li>',
            '<li><a href="' + root + '#learnings">Tech in Urdu</a></li>',
            '<li><a href="' + root + '#mathfun">Knowledge Check</a></li>',
