    ...
    el.innerHTML = [
      '<div class="lp-nav-inner">',
        ...
        '<nav class="lp-nav-links" id="lpNavLinks" aria-label="Main navigation">',
          '<a class="lp-nav-link' + active('school')    + '" href="' + root + 'for_school/index.html">🏫 School</a>',
          '<a class="lp-nav-link' + active('learnings') + '" href="' + root + 'learnings/index.html">🤖 Tech in Urdu</a>',
          '<a class="lp-nav-link' + active('mathfun')   + '" href="' + root + 'math_fun/quizzes/function-machine-quiz.html">🎮 Math Fun</a>',
      ...
      '<div class="lp-footer-inner">',
        ...
        '<div>',
          ...
          '<ul class="lp-footer-nav">',
            ...
            '<li><a href="' + root + 'for_school/index.html">School Worksheets</a></li>',
            '<li><a href="' + root + 'learnings/index.html">Tech in Urdu</a></li>',
            '<li><a href="' + root + 'math_fun/quizzes/function-machine-quiz.html">Math Fun</a></li>',
