...
check((11 - 1) === 10 && 10 === 10, 'Team-positive responses score toward 10');
check((11 - 10) === 1 && 1 === 1, 'Team-negative responses score toward 1');
...
check(!/negotiation_skills_test|Negotiation Skills Test|negotiation-skill|مذاکراتی/.test(enPage + urPage), 'No source-template topic residue remains');
...
check(home.includes('team_player_test/index.html'), 'Homepage links to English test');
check(home.includes('team_player_test/urdu.html'), 'Homepage links to Urdu test');
check(home.includes('Team Player Test') && home.includes('ٹیم پلیئر ٹیسٹ'), 'Homepage includes bilingual section title');
